...
public:
    CookingYoutubeChannel(std::string name, std::string ownerName) : YoutubeChannel(std::move(name), std::move(ownerName)){
    }
    static void Practice();
};

void CookingYoutubeChannel::Practice() {
    std::cout <<"Practicing cooking, learning new recipes." << std::endl;
}

int main() {
    CookingYoutubeChannel cookingYoutubeChannel("Tommy's Kitchen", "Tomislav");
